...
recipe_iron_ingot.results = {{type="item", name="iron-ingot-sat1", amount=1}}
recipe_iron_ingot.ingredients = {{type = "item", name = "iron-ore", amount = 1}}
...
recipe_copper_ingot.results = {{type="item", name="copper-ingot-sat1", amount=1}}
recipe_copper_ingot.ingredients = {{type = "item", name = "copper-ore", amount = 1}}
...
recipe_modular_frame.results = {{type="item", name="concrete-sat1", amount=1}}
recipe_modular_frame.ingredients = {{type = "item", name = "stone", amount = 3}}
...
recipe_iron_plate.results = {{type="item", name="iron-plate-sat1", amount=2}}
recipe_iron_plate.ingredients = {{type = "item", name = "iron-ingot-sat1", amount = 3}}
...
recipe_copper_sheet.results = {{type="item", name="copper-sheet-sat1", amount=1}}
recipe_copper_sheet.ingredients = {{type="item", name="copper-ingot-sat1", amount=2}}
...
recipe_iron_rod.results = {{type="item", name="iron-rod-sat1", amount=1}}
recipe_iron_rod.ingredients = {{type="item", name="iron-ingot-sat1", amount=1}}
...
recipe_iron_screw.results = {{type="item", name="iron-screw-sat1", amount=4}}
recipe_iron_screw.ingredients = {{type="item", name="iron-rod-sat1", amount=1}}
...
recipe_copper_wire.results = {{type="item", name="copper-wire-sat1", amount=2}}
recipe_copper_wire.ingredients = {{type="item", name="copper-ingot-sat1", amount=1}}
...
recipe_copper_cable.results = {{type="item", name="copper-cable-sat1", amount=1}}
recipe_copper_cable.ingredients = {{type="item", name="copper-wire-sat1", amount=2}}
...
recipe_reinforced_iron_plate.results = {{type="item", name="reinforced-iron-plate-sat1", amount=1}}
recipe_reinforced_iron_plate.ingredients = {
	{type="item", name="iron-plate-sat1", amount=6},
	{type="item", name="iron-screw-sat1", amount=12}
}
...
recipe_rotor.results = {{type="item", name="rotor-sat1", amount=1}}
recipe_rotor.ingredients = {
	{type="item", name="iron-rod-sat1", amount=5},
	{type="item", name="iron-screw-sat1", amount=25}
}
...
recipe_modular_frame.results = {{type="item", name="modular-frame-sat1", amount=2}}
recipe_modular_frame.ingredients = {
	{type="item", name="reinforced-iron-plate-sat1", amount=3},
	{type="item", name="iron-rod-sat1", amount=12}
}
recipe_modular_frame.enabled = false
recipe_modular_frame.category = "crafting"
...
recipe_modular_frame.results = {{type="item", name="smart-plating-sat1", amount=1}}
recipe_modular_frame.ingredients = {
	{type="item", name="reinforced-iron-plate-sat1", amount=1},
	{type="item", name="rotor-sat1", amount=1}
}
recipe_modular_frame.enabled = false
recipe_modular_frame.category = "crafting"
