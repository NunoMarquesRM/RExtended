...
{--Robot Logistic
	...
	results = {{type="item", name="red-robot-l", amount=1}}
},
{--Robot Construction
	type = "recipe",
	name = "red-robot-c",
	...
	results = {{type="item", name="red-robot-c", amount=1}}
},
{--Roboport
	type = "recipe",
	name = "red-roboport",
	...
	results = {{type="item", name="red-roboport", amount=1}}
},
{--Chest Storage
	type = "recipe",
	...
	results = {{type="item", name="red-chest-storage", amount=1}}
},
{--Chest Passive Provider
	...
	results = {{type="item", name="red-chest-passive-provider", amount=1}}
},
{--Chest Requester
	type = "recipe",
	...
	results = {{type="item", name="red-chest-requester", amount=1}}
},
{--Chest Buffer
	type = "recipe",
	...
	results = {{type="item", name="red-chest-buffer", amount=1}}
},
{--Chest Active Provider
	...
	results = {{type="item", name="red-chest-active-provider", amount=1}}
},
--ITEM
{--Robot Logistic
	type = "item",
